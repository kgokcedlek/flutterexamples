          ...
          Container(
            margin: EdgeInsets.only(top: 20),
             decoration: BoxDecoration(
               ...
               border: Border.all(
                  color: Theme.of(context).secondaryHeaderColor,//Colors.blueGrey.shade100, //TODO: theme this!
                         ...
                         children: <Widget>[
                           ...
                           InkWell(
                             ...
                             child: Container(
                               ...
                               margin: EdgeInsets.all(10),
                               decoration: BoxDecoration(
                                   color: Theme.of(context).primaryColorDark,//Colors.blueGrey.withOpacity(0.2),
                                 borderRadius: BorderRadius.circular(16)
                               ),
                               child: Center(child:Text("+",style: TextStyle(
                                   fontWeight: FontWeight.bold,
                   ...
                   Column(
                      children: <Widget>[
                        Slider(
                            min: 0.0,
                            max: 10.0,
                            activeColor: Theme.of(context).primaryColorDark, //Colors.red , //TODO: Theme this!
                            inactiveColor: Theme.of(context).secondaryHeaderColor, //TODO: Theme this!
                           // divisions: 10,
                            value: _interest,
